      ...
      <div class="card bg-base-100 shadow-xl max-w-2xl w-full">
        <div class="card-body items-center text-center p-8">
          ...
          <p class="text-base-content/70">
            Halaman pengaturan untuk Kader akan segera hadir. Fitur seperti
            pengaturan profil, preferensi notifikasi, dan bantuan akan tersedia
            di sini.
          </p>
...
export const head: DocumentHead = {
  title: "Pengaturan Kader - Si-DIFA",
  meta: [
    {
      name: "description",
      content: "Halaman pengaturan Kader Si-DIFA. Fitur akan segera tersedia.",
    },
  ],
};
