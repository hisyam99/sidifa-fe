...
export const NavigationPsikolog = component$(() => {
  ...
  const menuItems = [
    ...
    { href: "/psikolog/laporan-asesmen/", label: "Laporan Asesmen", icon: LuFileText },
  ];
    ...
    <nav class="navbar bg-base-100/80 backdrop-blur-md border-b border-base-200/50 sticky top-0 z-50 shadow-sm">
      <div class="container mx-auto px-4 flex items-center justify-between">
        <div class="navbar-start">
          ...
          <a href="/psikolog/" class="btn btn-ghost text-xl hover:bg-primary/10 transition-all duration-300">
            ...
            <div class="flex flex-col items-start">
              <span class="font-bold text-gradient-primary">Si-DIFA Psikolog</span>
