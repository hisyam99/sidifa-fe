  ...
  (props: AdminRecentActivityTableProps) => {
    ...
    return (
      <div class="relative overflow-hidden rounded-2xl border border-base-300/50 bg-base-100 shadow-sm transition-all duration-300 h-full flex flex-col">
        ...
        <header class="flex items-center justify-between gap-4 px-5 pt-5 pb-3 shrink-0">
          <div class="min-w-0">
        ...
        <div class="flex-1 min-h-0 overflow-y-auto overflow-x-auto overscroll-contain">
          <table class="table table-sm w-full">
            <thead class="sticky top-0 z-10">
              <tr class="border-b border-base-200">
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100">
                  #
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100">
                  Nama Kegiatan
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100 hidden md:table-cell">
                  Jenis
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100 hidden lg:table-cell">
                  Posyandu
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100 hidden sm:table-cell">
                  Lokasi
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100">
                  Tanggal
                </th>
                <th class="text-[11px] font-semibold uppercase tracking-wider text-base-content/40 bg-base-100 hidden xl:table-cell">
                  Waktu
                </th>
              </tr>
            </thead>
