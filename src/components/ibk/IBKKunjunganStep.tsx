  ...
  return (
    <>
      <div class="alert alert-info mb-4">
        ...
        <span>Lengkapi detail sosial, pendidikan, dan lokasi IBK. Data ini penting untuk pemetaan dan tindak lanjut.</span>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Field of={form} name="pekerjaan" type="string">
          {(field, props) => <FormFieldModular field={field} props={props} type="text" label="Pekerjaan" />}
        </Field>
        <Field of={form} name="pendidikan" type="string">
          {(field, props) => <FormFieldModular field={field} props={props} type="text" label="Pendidikan" />}
        </Field>
              ...
              <div class="mt-2">
                <MapPicker
                  ...
                  onLocationSelect$={$((lat: number, lng: number) => {
                    ...
                    const input = document.querySelector(`input[name="titik_koordinat"]`) as HTMLInputElement;
                    if (input) {
        ...
        <Field of={form} name="keterangan_tambahan" type="string">
          {(field, props) => <FormFieldModular field={field} props={props} type="textarea" label="Keterangan Tambahan" rows={3} />}
        </Field>
      </div>
    </>
  );
